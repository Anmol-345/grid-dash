...
type Props = {
  ...
  bindMenuController?: (showMenu: () => void) => void;
  onExit?: () => void;
};
...
export default function UIRoot({ onStart, onPauseChange, bindTimerController, bindMenuController, onExit }: Props) {
  ...
  }, [bindMenuController, onPauseChange, onExit]);
